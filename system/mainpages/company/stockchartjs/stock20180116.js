...
! function($) {
    ...
    var visitedAndPort = window.visitedAndPort = new function() {
        ...
        function _buildPort() {
            ...
            getScript('http://watchlist.finance.sina.com.cn/portfolio/api/openapi.php/HoldV2Service.getAllPySymbolsList?source=pc_mzx&type=cn&callback=var _myPort=&rn=' + random(), function() {
                while (_portList.length) {
                    _portList.pop().release();
                }
                $('#tbodyPort').empty();
