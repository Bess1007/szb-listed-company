...
/*7-10new add*/
$(function () {
	$('.companynamesli').click(function () {
		var $index = $(this).index();
		$(this).addClass('active').siblings('.companynamesli').removeClass('active');
		$('.ullis').eq($index).addClass('active').siblings().removeClass('active');
    })
})