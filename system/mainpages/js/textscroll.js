$(function () {
    ...
    $ul.css({ top: "-" + liFirstHeight - 0 + "px" });//利用css的top属性将第一个li隐藏在列表上方	 因li的上下padding:10px所以要-20
    ...
    $("#con").hover(function () {
        ...
        scrtime = setInterval(function scrolllist() {
            ...
            $ul.animate({ top: 0 + "px" }, 1500, function () {
                ...
                $ul.css({ top: "-" + liFirstHeight - 0 + "px" });//利用css的top属性将刚插入的li隐藏在列表上方  因li的上下padding:10px所以要-20
            });
        }, 3300);
